...
const BaseQuoteRate = ({base, quote, pair, rate}) => {
  ...
  return (
    <div className="h-full bg-neutral-700 dark:bg-neutral-50 border-l-2 border-neutral-500 flex flex-row items-center gap-2 px-4 py-4">
      <span className="text-neutral-200 dark:text-neutral-500 text-preset-6">{pair}</span>
      <span className="text-neutral-50 dark:text-neutral-900 text-preset-6">{rate}</span>
